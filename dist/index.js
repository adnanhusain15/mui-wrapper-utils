...
function createPalette(palette) {
  var _palette$primary = palette.primary,
    ...
    dark: _red.default[700]
      ...
      _palette$warning = palette.warning,
      warning = _palette$warning === void 0 ? {
    light: _amber.default[300],
    main: _amber.default[500],
    dark: _amber.default[700]
  } : _palette$warning,
      _palette$info = palette.info,
      info = _palette$info === void 0 ? {
...
var require$$9 = withStyles$1(styles$3, {
  name: 'MuiBackdrop'
})(Backdrop);
...
var _Backdrop = interopRequireDefault(require$$9);
...
var defaultTransitionDuration = {
  enter: transitions$1.duration.enteringScreen,
  exit: transitions$1.duration.leavingScreen
};
/**
...
var MuiDialogTitle = withStyles$1(styles$6, {
  name: 'MuiDialogTitle'
})(DialogTitle);
...
var MuiDialogContent = withStyles$1(styles$7, {
...
var MuiDialogActions = withStyles$1(styles$8, {
  name: 'MuiDialogActions'
})(DialogActions);

var useEnhancedEffect$2 = typeof window !== 'undefined' && process.env.NODE_ENV !== 'test' ? React__default.useLayoutEffect : React__default.useEffect;
/**
...
var require$$2 = withStyles$1(styles$c, {
  name: 'MuiSvgIcon'
})(SvgIcon);
...
var Button$1 = withStyles$1(styles$d, {
  name: 'MuiButton'
})(Button);

var DialogTitle$1 = function (props) {
    ...
    return (React__default.createElement(MuiDialogTitle, { disableTypography: true, className: classes.root },
        ...
        onClose ? (React__default.createElement(IconButton$1, { "aria-label": "close", className: classes.closeButton, onClick: onClose },
            React__default.createElement(CloseIcon, null))) : null));
};
var DialogActions$1 = function (props) {
    ...
    return (React__default.createElement(MuiDialogActions, null,
        ...
        (isCloseButton && !actionsChildren) &&
            (React__default.createElement(Button$1, { color: "primary", onClick: function () { onClose && onClose(); } }, (closeButtonText) ? closeButtonText : 'Close'))));
};
var AppDialog = function (props) {
    ...
    return (React__default.createElement(Dialog, __assign({ onClose: handleDialogClose, fullWidth: true, maxWidth: maxWidth }, rest),
        React__default.createElement(DialogTitle$1, { onClose: handleDialogClose }, title),
        React__default.createElement(MuiDialogContent, __assign({}, contentProps), children),
        (isActionCloseButton || actionsChildren) &&
            (React__default.createElement(DialogActions$1, { isCloseButton: isActionCloseButton, closeButtonText: closeButtonText, actionsChildren: actionsChildren, onClose: handleDialogClose }))));
};
var useDialogTitleStyles = makeStyles$1(function (theme) {
