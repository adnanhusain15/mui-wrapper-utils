...
var useEnhancedEffect$2 = typeof window !== 'undefined' && process.env.NODE_ENV !== 'test' ? React.useLayoutEffect : React.useEffect;
/**
...
var DialogTitle$1 = function (props) {
    ...
    return (React.createElement(MuiDialogTitle, { disableTypography: true, className: classes.root },
        React.createElement(Typography$1, { variant: "h6" }, children),
        onClose ? (React.createElement(IconButton$1, { "aria-label": "close", className: classes.closeButton, onClick: onClose },
...
var DialogActions$1 = function (props) {
    ...
    return (React.createElement(MuiDialogActions, null,
        ...
        (isCloseButton && !actionsChildren) &&
            (React.createElement(Button$1, { color: "primary", onClick: function () { onClose && onClose(); } }, (closeButtonText) ? closeButtonText : 'Close'))));
};
var AppDialog = function (props) {
    ...
    return (React.createElement(Dialog, __assign({ onClose: handleDialogClose, fullWidth: true, maxWidth: maxWidth }, rest),
        React.createElement(DialogTitle$1, { onClose: handleDialogClose }, title),
        React.createElement(MuiDialogContent, __assign({}, contentProps), children),
        (isActionCloseButton || actionsChildren) &&
            (React.createElement(DialogActions$1, { isCloseButton: isActionCloseButton, closeButtonText: closeButtonText, actionsChildren: actionsChildren, onClose: handleDialogClose }))));
};
...
export { DialogTitle$1 as DialogTitle };
