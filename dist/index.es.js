...
var Snackbar = React.forwardRef(function Snackbar(props, ref) {
  ...
  }, TransitionProps), children || React.createElement(SnackbarContent$1, _extends({
    message: message,
    action: action
  }, ContentProps)))));
});
...
var ToastMessageContent = function (props) {
    ...
    return (React.createElement(SnackbarContent$1, __assign({ className: clsx(classes[variant], className), "aria-describedby": "client-snackbar", message: React.createElement("span", { className: classes.message },
            React.createElement(Icon, { className: clsx(classes.icon, classes.iconVariant) }),
            message), action: [
            React.createElement(IconButton$1, { key: "close", "aria-label": "close", color: "inherit", onClick: onClose },
...
var ToastMessage = function (props) {
    ...
    return (React.createElement(Snackbar$1, __assign({}, snackBarProps),
...
export { AppDialog, DialogTitle$1 as DialogTitle, ToastInit, ToastMessage, ToastMessageContent };
